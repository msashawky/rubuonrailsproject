...
class RegisteredUsersControllerTest < ActionController::TestCase
  ...
  test "should create registered_user" do
    assert_difference('RegisteredUser.count') do
      post :create, registered_user: { apartment: @registered_user.apartment, card_number: @registered_user.card_number, city: @registered_user.city, country: @registered_user.country, governorate: @registered_user.governorate, street: @registered_user.street }
    end
  ...
  test "should update registered_user" do
    patch :update, id: @registered_user, registered_user: { apartment: @registered_user.apartment, card_number: @registered_user.card_number, city: @registered_user.city, country: @registered_user.country, governorate: @registered_user.governorate, street: @registered_user.street }
    assert_redirected_to registered_user_path(assigns(:registered_user))
  end
